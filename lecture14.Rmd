...
```{r echo=TRUE}
library(ggplot2)
data_23 <- read.csv("LING2200_vowels_2023.csv", header=TRUE)
vowel_space_23 <- ggplot(data_23, aes(x=F2, y=F1, label=Vowel)) + geom_text() + scale_x_reverse() + scale_y_reverse()
vowel_space_23
```
