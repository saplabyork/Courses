...
A larger unit of linguistic structure composed of organized gestures and segments (collections of features) is the syllable, which is generally at its bare minimum a vowel. The structure of the syllable can be filled out by one or more consonants either before or after the vowel.  
We can think of the syllable as giving the rhythm of a word, an organizational timing structure $\rightarrow$ it’s the “clapping” unit around which we time our utterance.
