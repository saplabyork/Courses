...
The first week of class we dive into our subject matter by introducing some basic concepts underlying the acoustics of speech. In order to get to there, however, we need to begin with some definitions of concepts from physics, which we will rely on for the rest of the course. [Ch.1](docs/ch1-Sound.pdf)
