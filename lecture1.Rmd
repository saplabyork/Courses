...
The first week of class we dive into our subject matter by introducing some basic concepts underlying the production of speech. In order to get to there, we need to begin with physical concepts which we will rely on for the rest of the course.
