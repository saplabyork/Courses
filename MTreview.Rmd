...
Work on the below problems then watch this [video](), which has the solutions I've worked out.
...
3. What is the period of a tone with a wavelength of 600cm?

## Intensity to dB

4. Suppose a reference sound has an intensity of 5.5 x $10^{-5}$ $W/m^2$. How loud is this sound in decibels?
5. If a reference sound has an intensity of 0.04 $W/m^2$, what is its value in decibels?
...
8. How long is a tube that has an $F_2$ of 1500Hz?
